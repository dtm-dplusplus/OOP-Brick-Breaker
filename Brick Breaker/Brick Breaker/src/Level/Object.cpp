...
Object::Object()
{
	...
	m_ObjectName = "Object" + std::to_string(ObjectID);
}
...
{
	if (m_IsRender) {Renderer::RenderTexture(m_Texture, m_Collider);}
...
bool& Object::GetIsRender()
{
	return m_IsRender;
}

bool Object::GetIsRender() const
{
	return m_IsRender;
}

void Object::SetIsRender(const bool _isrender)
{
